...
public class TCPServerCtr {
    ...
    public void publicUserOnline(){
        ...
        if( listProcessing.isEmpty()) return;
    ...
    public void publicGroup(User u){
        ...
        for (ServerProcessing myProcessing : listProcessing) {
            if( myProcessing.getUserOfPro().getUsername().equals(u.getUsername())) continue;
...
//        int idUser = 0;
//        if( userReceive instanceof Friend)
//            idUser = ((Friend) userReceive).getId();
//        else if( userReceive instanceof User)
//            idUser = ((User) userReceive).getId();
